...
const RightSideMessage = ({ user }: any) => {
    ...
    if (loading) {
        return <div className="lg:col-span-2 lg:block  relative ">
            ...
            <div className="lg:col-span-2 lg:block relative ">
                <div className="w-full h-full  relative flex flex-col">
                    ...
                    {Object.keys(user).length > 0 ? <>
                        ...
                        <img src="https://cdni.iconscout.com/illustration/premium/thumb/chat-with-a-mobile-application-illustration-download-in-svg-png-gif-file-formats--messaging-communication-chatbot-business-technology-pack-illustrations-7772301.png?f=webp" alt="Chat SVG" className='object-cover' />
                    </>}
